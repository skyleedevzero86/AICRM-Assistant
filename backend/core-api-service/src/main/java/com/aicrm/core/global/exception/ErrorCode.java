...
public enum ErrorCode {
    ...
    DUPLICATE_EMPLOYEE_NO("DUPLICATE_EMPLOYEE_NO", HttpStatus.CONFLICT, "이미 사용 중인 사원번호입니다"),
    INVALID_EMPLOYEE_NO("INVALID_EMPLOYEE_NO", HttpStatus.BAD_REQUEST, "사원번호 형식이 올바르지 않습니다"),
