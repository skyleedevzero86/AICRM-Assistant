...
@Service
public class UploadCustomerTicketAttachmentService {
    ...
    public UploadCustomerTicketAttachmentService(
    ...
    public UploadAttachmentResponse upload(Long ticketId, MultipartFile file, Long messageId) {
        ...
        return storeAttachment(ticketId, resolvedMessageId, customerId, file);
    }
